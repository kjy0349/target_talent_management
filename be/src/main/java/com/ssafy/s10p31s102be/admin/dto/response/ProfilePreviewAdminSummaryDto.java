...
@AllArgsConstructor
@Builder
public class ProfilePreviewAdminSummaryDto {
    ...
    public static ProfilePreviewAdminSummaryDto fromEntity(Profile profile) {
        ...
        return ProfilePreviewAdminSummaryDto.builder()
