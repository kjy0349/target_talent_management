...
@AllArgsConstructor
@Builder
public class ProjectAdminProfilePreviewDto {
    ...
    public static ProjectAdminProfilePreviewDto fromEntity(Profile profile, List<NetworkingProfile> networkingProfiles) {
        return ProjectAdminProfilePreviewDto.builder()
                ...
                .networkingExecutivePreviews( networkingProfiles.stream().map( NetworkingProfile::getNetworking).map(NetworkingExecutivePreview::fromEntity).toList())
                .build();
    }
}
