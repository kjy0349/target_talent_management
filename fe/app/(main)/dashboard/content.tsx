...
import { Badge, Dropdown, Select, Table, useThemeMode } from "flowbite-react";
...
import {
  DashbaordCountrySearchConditionDto,
  Dashboard,
  DashboardDepartmentSearchConditionDto,
...
import DashboardCountryModal from "@/components/dashboard/DashboardCountryModal";
...
const DashboardPageContent: FC<DashboardPageData> = function ({ dashboard }) {
  ...
  const [countrySearchCondition, setCountrySearchContion] =
    useState<DashbaordCountrySearchConditionDto>({
      viewMonth: now.getFullYear(),
      viewYear: now.getMonth() + 1,
    });
  ...
  const ServerStartDate = "2024-04";
  const generateYearMonthOptions = (start: string, end: Date) => {
  ...
  const [date, setDate] = useState<string>("2024.04");
  const handleOnDateChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
  ...
  useEffect(() => {
    ...
    setCountrySearchContion(nextCondition);
    searchCountryStatics(nextCondition);
  }, [date]);
  const YearMonthSelect = () => {
    const options = generateYearMonthOptions(ServerStartDate, now);

    return (
      <Select value={date} onChange={handleOnDateChange}>
  ...
  const searchCountryStatics = async (
    searchCondition: DashbaordCountrySearchConditionDto,
  ) => {
    const countryResponse = await localAxios.post(
    ...
    <div className="px-4 pt-6">
      <div className="flex w-full flex-col gap-1">
        <div className="flex size-full">
          <div className="flex h-64 w-3/5 flex-col">
                ...
                <div className="flex h-full items-center justify-center rounded-lg border border-gray-200 bg-white p-6 text-center shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                  <div className="">
                    ...
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                      {dashBoardState.mainPageContent.totalPoolSize}명
                    </h5>
                  </div>
                </div>
              </div>
              <div className=" h-full w-1/3">
                <div className="flex h-full items-center justify-center rounded-lg border border-gray-200 bg-white p-6 text-center shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                  <div className="">
                    ...
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                      {dashBoardState.mainPageContent.ePollSize}명
                    </h5>
                  </div>
                </div>
              </div>
              <div className=" h-full w-1/3">
                <div className="flex h-full items-center justify-center rounded-lg border border-gray-200 bg-white p-6 text-center shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                  <div className="">
                    ...
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                      {dashBoardState.mainPageContent.developerPoolSize}명
                    </h5>
                  </div>
                </div>
              </div>
              ...
              <div className=" h-full w-1/3">
                <div className="flex h-full items-center justify-center rounded-lg border border-gray-200 bg-white p-6 text-center shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                  <div className="">
                    ...
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                      {dashBoardState.mainPageContent.pPollSizePoolSize}명
                    </h5>
                  </div>
                </div>
              </div>
              <div className=" h-full w-1/3">
                <div className="flex h-full items-center justify-center rounded-lg border border-gray-200 bg-white p-6 text-center shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                  <div className="">
                    ...
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                      {dashBoardState.mainPageContent.networkingPoolSize}명
                    </h5>
                  </div>
                </div>
              </div>
              <div className=" h-full w-1/3">
                <div className="flex h-full items-center justify-center rounded-lg border border-gray-200 bg-white p-6 text-center shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                  <div className="">
                    ...
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                      {dashBoardState.mainPageContent.techmapPoolSize}명
                    </h5>
                  </div>
                </div>
              </div>
          ...
          <div className="h-64 w-2/5">
            <AcquisitionOverview dashboard={dashBoardState} />
          </div>
        </div>
        <div className="flex h-[500px]">
          <div className="w-1/2">
            <UserSignupsThisWeek dashboard={dashBoardState} />
          </div>
          <div className="flex w-1/2 flex-col">
            <div className="h-2/5">
              <VisitorsThisWeek dashboard={dashBoardState} />
            </div>
            <div className="h-3/5">
              <div className="flex h-full rounded-lg border border-gray-200 bg-white p-6 text-center shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                <div className="flex w-full flex-col">
                  <div className="flex w-full justify-between ">
                    ...
                    <div className="flex items-center gap-1">
                      <div>
                        <Badge className="h-10">조회년월</Badge>
                      </div>
                      {YearMonthSelect()}
                    </div>
                  </div>
                  <div
                    className="flex size-full flex-col items-center justify-center gap-3 font-semibold"
                    onClick={openCountryModal}
                  >
                    <div className="flex w-full">
                      {Object.entries(dashBoardState.sessionsByCountryMap)
                        .sort(([, a], [, b]) => b.visitors - a.visitors) // 방문자 수 기준 내림차순 정렬
                        .slice(0, 2)
                        .map(([country, { visitors, change }], index) => (
                          <div
                            key={index}
                            className="flex w-1/2 justify-center"
                          >
                            {index + 1}. {country ? country : "국가 이름 없음"}{" "}
                            {visitors.toLocaleString()}명 (
                            {change.toLocaleString()}명{" "}
                            {change > 0 ? <HiArrowUp /> : <HiArrowDown />})
                          </div>
                        ))}
                    </div>
                    <div className="flex w-full">
                      {Object.entries(dashBoardState.sessionsByCountryMap)
                        ...
                        .map(([country, { visitors, change }], index) => (
                          <div
                            ...
                            className="flex w-1/2 justify-center"
                          >
                            {index + 3}. {country ? country : "국가 이름 없음"}{" "}
                            {visitors.toLocaleString()}명 (
                            {change.toLocaleString()}명{" "}
                            {change > 0 ? <HiArrowUp /> : <HiArrowDown />})
                          </div>
                      ...
                      {Object.entries(dashBoardState.sessionsByCountryMap)
                        ...
                        .map(([country, { visitors, change }], index) => (
                          <div
                            ...
                            className="flex w-1/2 justify-center"
                          >
                            {index + 5}. {country ? country : "국가 이름 없음"}{" "}
                            {visitors.toLocaleString()}명 (
                            {change.toLocaleString()}명{" "}
                            {change > 0 ? <HiArrowUp /> : <HiArrowDown />})
                          </div>
...
//         <div className="shrink-0">
//           <span className="text-2xl font-bold leading-none text-gray-900 dark:text-white sm:text-3xl">
//             {dashboard.newProductsThisWeek.products}
//           </span>
//           <h3 className="text-base font-normal text-gray-600 dark:text-gray-400">
...
const VisitorsApexChart: FC<DashboardPageData> = function ({ dashboard }) {
  ...
  const options: ApexCharts.ApexOptions = {
    ...
    xaxis: {
      categories: dashboard.visitorsThisWeek.labels,
      labels: {
        show: true,
        rotate: 0,
        style: {
          colors: Array(dashboard.visitorsThisWeek.labels.length).fill(
            "#4B5563",
          ),
          fontSize: "14px",
          fontFamily: "Inter, sans-serif",
...
const UserSignupsThisWeek: FC<DashboardPageData> = function ({ dashboard }) {
  ...
  const [departmentSearchCondition, setDepartmentSearchCondition] =
    useState<DashboardDepartmentSearchConditionDto>({
      jobRankId: 0,
      skillMainCategory: "",
    });
  const [monthlySearchCondition, setMonthlySearchCondition] =
  ...
  const baseSetting = async () => {
    const jobRanksResponse =
      await localAxios.get<JobRankAdminSummary[]>(`/admin/jobrank`);

    setJobRanks(jobRanksResponse.data);
    const skillsResponse = await localAxios.get<string[]>(
      `/dashboard/profile/skill`,
    );

    setSkills(skillsResponse.data);
    // console.log("departments", jobRanksResponse);
  };
  const searchDepartmentStatics = async (
    searchCondition: DashboardDepartmentSearchConditionDto,
  ) => {
    const staticsResponse = await localAxios.post(
      `/dashboard/main/department`,
      searchCondition,
    );
    setDashboardState({
      ...dashboard,
      userSignupsThisWeek: staticsResponse.data,
    });
  };
  const handleOnChangeDepartmentJobRank = (
    e: React.ChangeEvent<HTMLSelectElement>,
  ) => {
    const nextCondtion = {
      ...departmentSearchCondition,
      jobRankId: Number(e.target.value),
    };
    searchDepartmentStatics(nextCondtion);
    setDepartmentSearchCondition(nextCondtion);
  };

  const handleOnChangeDepartmentSkill = (
    e: React.ChangeEvent<HTMLSelectElement>,
  ) => {
    const nextCondtion = {
      ...departmentSearchCondition,
      skillMainCategory: e.target.value,
    };
    searchDepartmentStatics(nextCondtion);
    setDepartmentSearchCondition(nextCondtion);
  };
  ...
  return (
    <div className="flex size-full justify-center rounded-lg border border-gray-200 bg-white px-6 text-center shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
      <div className="flex size-full flex-col">
        <div className="flex">
          <div className="mb-12 mt-5 flex w-full justify-between">
            <h5 className=" text-3xl font-bold tracking-tight text-gray-900 dark:text-white">
              사업부별 인재 Pool 현황
            </h5>
            <div className="flex items-center gap-1">
              <div>
                <Badge className="h-10">직급</Badge>
              </div>
              <Select
                value={departmentSearchCondition?.jobRankId}
                onChange={handleOnChangeDepartmentJobRank}
              >
              ...
              <div>
                <Badge className="h-10">직무</Badge>
              </div>
              <Select
                value={departmentSearchCondition.skillMainCategory}
                onChange={handleOnChangeDepartmentSkill}
              >
        ...
        {dashBoardState.userSignupsThisWeek.labels.length > 0 ? (
          <UserSignupsApexChart dashboard={dashBoardState} />
        ) : (
          <div> 데이터가 없습니다. </div>
        )}
...
const UserSignupsApexChart: FC<DashboardPageData> = function ({ dashboard }) {
  ...
  const labels = dashboard.userSignupsThisWeek.labels;
  const options: ApexCharts.ApexOptions = {
  ...
  const [widthForGraph, setWidthForGraph] = useState<number | undefined>(
    undefined,
  );
  ...
  useEffect(() => {
    if (chartRef.current) {
      ...
      setWidthForGraph(chartWidth / labels.length);
    }
  }, [labels.length]);
...
const AcquisitionOverview: FC<DashboardPageData> = function ({ dashboard }) {
  ...
  const indicaters = [
    <span
      key={0}
      className={`me-3 flex size-3 rounded-full`}
      style={{ backgroundColor: `${indicatersBg[0]}` }}
    ></span>,
    <span
      key={0}
      className={`me-3 flex size-3 rounded-full`}
      style={{ backgroundColor: `${indicatersBg[1]}` }}
    ></span>,
    <span
      key={0}
      className={`me-3 flex size-3 rounded-full`}
      style={{ backgroundColor: `${indicatersBg[2]}` }}
    ></span>,
    <span
      key={0}
      className={`me-3 flex size-3 rounded-full`}
      style={{ backgroundColor: `${indicatersBg[3]}` }}
    ></span>,
    <span
      key={0}
      className={`me-3 flex size-3 rounded-full`}
      style={{ backgroundColor: `${indicatersBg[4]}` }}
    ></span>,
    <span
      key={0}
      className={`me-3 flex size-3 rounded-full`}
      style={{ backgroundColor: `${indicatersBg[5]}` }}
    ></span>,
  ];

  return (
    <div className="block size-full rounded-lg border border-gray-200 bg-white p-6 shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
      <h3 className="text-xl font-bold leading-none text-gray-900 dark:text-white">
        직급 별 현황
      </h3>
      <div className="flex h-48 w-full">
        ...
        <div className="mx-10 flex h-full w-2/5 flex-col items-center">
          {dashboard.acquisitionOverview.labels.map((str, index) => (
            <div key={index} className="flex w-full items-center text-sm">
              {indicaters[index % indicaters.length]} {str} :{" "}
              {dashboard.acquisitionOverview.series[index]}%
            </div>
          ))}
        </div>
      </div>
...
const AcquisitionApexChart: FC<DashboardPageData> = function ({ dashboard }) {
  ...
  return (
    <ApexChart height={220} options={options} series={series} type="donut" />
  );
};
